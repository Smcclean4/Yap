  ...
  useEffect(() => {
    if (profileInfoFromDatabase) {
      setProfileData({
        ...
        image: profileInfoFromDatabase.image || "/ezgif.com-webp-to-jpg.jpg"
      })
    }
      ...
      <div className="w-3/4 text-center flex flex-col flex-wrap justify-center items-center">
        <div className=" flex flex-col items-center">
          <div className="h-48 w-48 border-2 border-white bg-white flex justify-center items-center rounded-full overflow-hidden">
            <Image 
              src={profileInfoFromDatabase?.image && profileInfoFromDatabase.image !== '' ? profileInfoFromDatabase.image : profileData.image} 
              alt='Profile' 
              height="200" 
              width="200" 
              priority 
