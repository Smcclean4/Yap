...
const HomePage = () => {
  ...
  return (
    <Layout>
      ...
      <div className="w-full flex flex-col lg:flex-row justify-around items-center py-10 bg-gray-200 overflow-scroll h-auto">
        <div className="w-4/5 lg:w-2/5 text-sm sm:text-lg md:text-xl xl:text-2xl xl:leading-10 tracking-wider text-center">
        ...
        <div className="flex flex-col w-3/4 lg:w-2/5 h-full">
