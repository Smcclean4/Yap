...
export const RequestModal = ({ isShowing, hide, user, sendrequest }: RequestInterface) => isShowing ? createPortal(
  <div className='absolute top-0 right-0 left-0 bottom-0 w-3/4 h-3/4 m-auto flex flex-col text-center justify-center items-center rounded-2xl bg-gray-600 z-50'>
